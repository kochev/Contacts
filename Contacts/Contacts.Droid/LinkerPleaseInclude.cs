...
namespace Contacts.Droid
{
    ...
    public class LinkerPleaseInclude
    {
        ...
        public void Include(Chip chip)
        {
            chip.Click += (s, e) => chip.Text = $"{chip.Text}";
            chip.Typeface = null;
            chip.TextChanged += (sender, args) => { chip.Text = $"{chip.Text}"; };
        }
        ...
        public void Include(RelativeLayout layout)
        {
        ...
        public void Include(MvxSpinner spinner)
        {
            ...
            spinner.NothingSelected += (sender, args) => { };
        }
